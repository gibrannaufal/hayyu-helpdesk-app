...
const Hero = () => {
    ...
    return <>
        <Layouts />
        <div className="container mx-auto px-4 mt-16 hidden md:block">
		...
		<div className="relative bg-[#dcdcdc] opacity-100 hidden md:block"  >
		...
		{/* mobile */}
		<div className="mx-auto px-4 relative overflow-hidden md:hidden">
            <div className="pt-12 ml-4 h-[calc(100svh-62px)]  bg-white  flex flex-col item-left">
                <span className="text-[#038D77] font-montserrat font-bold text-[55px] text-left">
                    Helpdesk
                </span>
                <span className="w-[300px] text-[#3e3e3e] font-montserrat font-normal text-[17px] mt-2 mb-3 text-left">
					Selamat Datang di Pusat Bantuan Kami
				</span>
                <span className="text-[#6c6c6c] font-montserrat font-medium text-[15px] text-left max-w-[100vw] ">
                	Tempat di mana kami berkomitmen untuk memberikan layanan terbaik
                    kepada Anda. Silakan sampaikan keluhan atau pertanyaan Anda.
                </span>
				<div className="w-[395px] h-[50vh] bg-[#038D77] ml-[18vw]  -top-0 mt-[70vw]  opacity-100 absolute  rounded-[9999999px]"></div>
				<div className="w-[50vw] h-[50vh]  object-top absolute -top-0 ml-[40vw] mt-[68vw]  bg-[url('./assets/images/v6347_806.png')] bg-no-repeat bg-center bg-cover"></div>
            </div>

			
            <section className="py-6" id="faq">
                <h2 className="text-center font-bold text-[35px] text-[#038D77] font-montserrat">
                    FAQ
                </h2>
                <div className="p-2">
                    <span className="text-[#1f1f1f] font-montserrat font-bold text-2xl text-left">Akun User</span>
            ...
            <section className="py-12" id="kebijakan">
                ...
                <div className="p-2 opacity-100 grid">
					<div className="grid">
                        <h4 className="text-[#1f1f1f] font-montserrat font-bold text-2xl opacity-100 mb-4 justify-self-start">
                            Syarat dan Ketentuan
                        </h4>
		...
		<div className="relative bg-[#dcdcdc] opacity-100 md:hidden"  >
			<div className="py-12  h-screen" id="bantuan">
				<h2 className="text-center font-bold text-[35px] text-[#038D77] font-montserrat">
						BANTUAN
				</h2>
				<span className="block text-center font-montserrat text-[10px] font-medium leading-[30.48px]">
						Apa yang bisa kami bantu hari ini? Silahkan tulis kendala anda disini
				</span>
				<form className="grid grid-cols-1 gap-4 mt-4 max-w-80 mx-auto" onSubmit={handleSubmit}>
					<div className="col-start-1 col-end-7 flex justify-center">
						<input 
							className="w-full h-[50px] px-6 py-6 rounded-xl bg-[#f0f0f0] border border-[#bebebe] focus:outline-none focus:ring-2 focus:ring-[#038D77]" 
							placeholder="Judul"  
							name="judul" 
							value={FormData.judul} 
							onChange={handleInputChange}
					...
					<div className="col-start-1 col-end-7 mt-2 flex justify-center">
						<textarea 
								className="w-full h-[330px] px-6 py-6 rounded-xl bg-[#f0f0f0] border border-[#bebebe] resize-none focus:outline-none focus:ring-2 focus:ring-[#038D77]"  
								placeholder="Deskripsi" 
								name="deskripsi"
								value={FormData.deskripsi} 
								onChange={handleInputChange}
					...
					<div className="col-end-7 mt-3">
						<button type="submit" className="w-[140px] h-[65px] px-6 py-6 rounded-xl bg-[#038D77]">
							<span className="font-montserrat text-xl font-bold text-white flex items-center justify-center cursor-pointer transition-colors duration-300">
								Kirim 
							</span>
						</button>
